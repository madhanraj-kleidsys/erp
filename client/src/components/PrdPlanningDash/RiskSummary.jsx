        ...
        <CssVarsProvider>
            <Box sx={{ display: "flex", minHeight: "100dvh" }}>
                ...
                <Box sx={{ flexGrow: 1, p: 3 }}>
                    <Header />
                    <Box sx={{ pt: 3, pb: 2, flex: 1, display: "flex", flexDirection: "column", gap: 3 }}>
                                ...
                                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                    <Box>
                                        <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                                            <DangerousOutlined sx={{ fontSize: 40, mr: 2, color: "#FEF2F2" }} />
                                            <Typography level="h1" sx={{ fontWeight: 900, fontSize: "2.5rem" }}>
                                                Risk & Exception Summary
                                            </Typography>
                                        </Box>
                                        <Typography level="body-lg" sx={{ opacity: 0.9,color:"#e2e2e2ff"}}>
                        ...
                        <Card sx={{
                            ...
                            <CardContent sx={{ p: 4 }}>
                                <Box sx={{ display: "flex", alignItems: "center", mb: 4 }}>
                                    ...
                                    <Typography level="h3" sx={{ fontWeight: 800, color: "#2a89e9ff" }}>
                        ...
                        <Card sx={{
                            ...
                            <CardContent sx={{ p: 4 }}>
                                <Typography level="h4" sx={{ fontWeight: 800, color: "#0878e9ff", mb: 4 }}>
                        ...
                        <Card sx={{
                            ...
                            <CardContent sx={{ p: 4 }}>
                                <Typography level="h4" sx={{ fontWeight: 800, color: "#167ee6ff", mb: 4 }}>
                                    Delay Escalation Table
                                </Typography>
                                <Table sx={{
                                    "--Table-headerUnderlineThickness": "2px",
